...
public class FeatureBuilderRelational implements FeatureBuilder {
	 ...
	 * <code>null</code>
	 * @param escalationPolicy the void escalation policy, must not be <code>null</code>
	 */
	...
	private void addProperties(List<Property> props, PropertyType pt, Mapping propMapping, ResultSet rs,
			String idPrefix) throws SQLException {
	...
	private List<TypedObjectNode> buildParticles(Mapping mapping, ResultSet rs,
			LinkedHashMap<String, Integer> colToRsIdx, String idPrefix) throws SQLException {
	...
	private Pair<ResultSet, LinkedHashMap<String, Integer>> getJoinedResultSet(TableJoin jc, Mapping mapping,
			ResultSet rs, LinkedHashMap<String, Integer> colToRsIdx) throws SQLException {
