...
public class QueryKVPAdapter extends AbstractWFSRequestKVPAdapter {
	...
	protected static List<Query> parseQueries200(Map<String, String> kvpUC) throws Exception {
	...
	private static List<Query> parseAdhocQueries200(Map<String, String> kvpUC) throws Exception {
