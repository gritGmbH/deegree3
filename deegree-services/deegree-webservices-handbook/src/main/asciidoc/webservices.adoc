...
Using option element _GeoJSONFormat_, it possible to enable GeoJSON as GetFeature output format.
...
Using option element _CsvFormat_, it possible to enable CSV as GetFeature output format.
