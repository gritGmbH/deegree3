...
<ProcessDefinition configVersion="3.4.0" processVersion="1.0.0" xmlns="http://www.deegree.org/processes/java"
  xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.deegree.org/processes/java http://schemas.deegree.org/3.5.0/processes/java/java.xsd">
...
<ProcessDefinition configVersion="3.4.0" processVersion="1.0.0" storeSupported="true" statusSupported="false"
  ...
  xsi:schemaLocation="http://www.deegree.org/processes/java http://schemas.deegree.org/3.5.0/processes/java/java.xsd">
...
schema file http://schemas.deegree.org/3.5.0/processes/java/java.xsd.
...
(http://schemas.deegree.org/3.5.0/processes/java/java.xsd).
