...
<ShapeFeatureStore configVersion="3.4.0"
  ...
  http://schemas.deegree.org/3.5.0/datasource/feature/shape/shape.xsd">
...
by schema file
http://schemas.deegree.org/3.5.0/datasource/feature/shape/shape.xsd. The
...
<MemoryFeatureStore configVersion="3.4.0"
  ...
  http://schemas.deegree.org/3.5.0/datasource/feature/memory/memory.xsd">
...
<SimpleSQLFeatureStore configVersion="3.4.0"
  ...
  http://schemas.deegree.org/3.5.0/datasource/feature/simplesql/simplesql.xsd">
...
<SQLFeatureStore configVersion="3.4.0"
  ...
  http://schemas.deegree.org/3.5.0/datasource/feature/sql/sql.xsd">
...
<SQLFeatureStore xmlns="http://www.deegree.org/datasource/feature/sql" xmlns:xlink="http://www.w3.org/1999/xlink"
  ...
  xsi:schemaLocation="http://www.deegree.org/datasource/feature/sql http://schemas.deegree.org/3.5.0/datasource/feature/sql/sql.xsd">
...
http://schemas.deegree.org/3.5.0/datasource/feature/sql/sql.xsd. The
