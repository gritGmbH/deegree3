...
<DataSourceConnectionProvider configVersion="3.4.0"
  ...
  xsi:schemaLocation="http://www.deegree.org/connectionprovider/datasource http://schemas.deegree.org/3.5.0/jdbc/datasource/datasource.xsd">
...
http://schemas.deegree.org/3.5.0/jdbc/datasource/datasource.xsd. The
...
<JDBCConnection configVersion="3.4.0" xmlns="http://www.deegree.org/jdbc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                xsi:schemaLocation="http://www.deegree.org/jdbc http://schemas.deegree.org/3.5.0/jdbc/jdbc.xsd">
...
http://schemas.deegree.org/3.5.0/jdbc/jdbc.xsd. The root element is
