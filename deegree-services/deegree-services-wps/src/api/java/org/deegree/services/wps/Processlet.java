 ...
 * file that has to validate against <a href="http://schemas.deegree.org/3.5.0/wps/process_definition.xsd">
 * http://schemas.deegree.org/3.5.0/wps/process_definition.xsd</a>). Besides the definition of metadata, the XML
